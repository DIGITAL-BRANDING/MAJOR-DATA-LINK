...
import { Bell, ChevronDown, Fingerprint, GraduationCap, IdCard, LayoutDashboard, LogOut, Menu, MessageCircle, PackageOpen, ReceiptText, Smartphone, WalletCards, Wifi, X, Users } from 'lucide-react';
...
const groups = [
  ...
  { label: 'JAMB Services', icon: GraduationCap, items: [['JAMB documents & admission', '/jamb-services']] },
